...
{
       0,    85,    85,    87,    89,    90,    91,    98,    99,   123,
     124,   126,   127,   129,   133,   141,   151,   179,   195,   196,
     197,   199,   200,   202,   211,   214,   217,   218,   244,   245,
     246,   247,   248,   249,   256,   263,   289,   324,   416,   417,
     419,   420,   424,   446,   447,   450,   487,   488,   491,   517,
     520,   531,   534,   545,   549,   560,   571,   575,   586,   597,
     608,   619,   622,   634,   645,   648,   659,   670,   677,   680,
     685,   693,   699,   701,   720,   721,   722
};
#endif
...
#line 99 "parser.y"
				...
				if ((yyval.no) != NULL) {
            				ILOCList *code = iloc_new_list();

        	          		if ((yyvsp[-2].no) && (yyvsp[-2].no)->code)
	                    			code = concat(code, (yyvsp[-2].no)->code);

		                	if ((yyvsp[0].no) && (yyvsp[0].no)->code)
                		    		code = concat(code, (yyvsp[0].no)->code);	
...
#line 129 "parser.y"
                       { (yyval.no) = asd_new((yyvsp[0].valor_lexico)->valor, TYPE_DECIMAL);
...
#line 133 "parser.y"
                       { (yyval.no) = asd_new((yyvsp[0].valor_lexico)->valor, TYPE_INTEIRO);
				(yyval.no)->temp = new_temp();
                                (yyval.no)->code = iloc_new_list();
                                append_instr((yyval.no)->code, new_instr("loadI", (yyvsp[0].valor_lexico)->valor, NULL, (yyval.no)->temp));
				free((yyvsp[0].valor_lexico)->valor);
				free((yyvsp[0].valor_lexico));}
#line 1631 "parser.c"
    break;
				...
				(yyval.no) = (yyvsp[-1].no);
            	  ...
            	  if ((yyval.no) != NULL) {
                	ILOCList *code = iloc_new_list();
        	          ...
        	          if ((yyvsp[-1].no) && (yyvsp[-1].no)->code)
	                    	code = concat(code, (yyvsp[-1].no)->code);
...
#line 264 "parser.y"
				...
				if ((yyvsp[-2].no)->type == TYPE_DECIMAL && (yyvsp[0].no)->type == TYPE_INTEIRO){
			       ...
			       asd_add_child((yyval.no), (yyvsp[0].no));
				Symbol *sym = lookup_symbol((yyvsp[-4].valor_lexico)->valor);
        			(yyval.no)->code = iloc_new_list();
				(yyval.no)->temp = new_temp();
				append_instr((yyval.no)->code, new_instr("loadI", (yyvsp[0].no)->label, NULL, (yyval.no)->temp));
				append_instr((yyval.no)->code, new_instr("storeAI", (yyval.no)->temp, "rfp", sym->offset_str));
			       free((yyvsp[-4].valor_lexico)->valor);
			       free((yyvsp[-4].valor_lexico));
			       asd_free((yyvsp[-2].no)); 
			}
...
#line 290 "parser.y"
			 ...
			 (yyval.no) = asd_new(":=", sym->type);
			      ...
			      asd_add_child((yyval.no), id_node);
			      asd_add_child((yyval.no), (yyvsp[0].no));
				(yyval.no)->code = (yyvsp[0].no)->code;
				(yyval.no)->temp = (yyvsp[0].no)->temp;
				if (is_global(sym)) {
					append_instr((yyval.no)->code, new_instr("storeAI", (yyval.no)->temp, "rbss", sym->offset_str));
				} else {
					append_instr((yyval.no)->code, new_instr("storeAI", (yyval.no)->temp, "rfp", sym->offset_str));
				}
			 }
...
#line 425 "parser.y"
		  ...
		  (yyval.no) = asd_new("retorna", (yyvsp[0].no)->type);
			...
			asd_free((yyvsp[0].no));
			(yyval.no)->code = (yyvsp[-2].no)->code;
			(yyval.no)->temp = (yyvsp[-2].no)->temp;
		}
#line 2026 "parser.c"
    break;
...
#line 451 "parser.y"
			...
			(yyval.no)->code = iloc_new_list();
			(yyval.no)->code = (yyvsp[-5].no)->code;
			(yyval.no)->temp = (yyvsp[-5].no)->temp;
			...
			append_instr((yyval.no)->code, new_instr("cbr", (yyval.no)->temp, L_true, L_false));
			append_instr((yyval.no)->code, new_label_instr(L_true));
			if ((yyvsp[-2].no) != NULL) {
				(yyval.no)->code = concat((yyval.no)->code, (yyvsp[-2].no)->code);
			}	

			if ((yyvsp[0].no) != NULL) {
				append_instr((yyval.no)->code, new_instr("jumpI", NULL, NULL, L_end));
				append_instr((yyval.no)->code, new_label_instr(L_false));
				(yyval.no)->code = concat((yyval.no)->code, (yyvsp[0].no)->code);
				append_instr((yyval.no)->code, new_label_instr(L_end));
			} else {
				// Sem else → false cai direto no end
				append_instr((yyval.no)->code, new_label_instr(L_false));
    			}
		}
#line 2077 "parser.c"
...
#line 492 "parser.y"
			...
			(yyval.no)->code = iloc_new_list();
			append_instr((yyval.no)->code, new_label_instr(L_begin));
			(yyval.no)->code = concat((yyval.no)->code, (yyvsp[-4].no)->code);
			(yyval.no)->temp = (yyvsp[-4].no)->temp;
		
			append_instr((yyval.no)->code, new_instr("cbr", (yyval.no)->temp, L_body, L_end));
			append_instr((yyval.no)->code, new_label_instr(L_body));
			(yyval.no)->code = concat((yyval.no)->code, (yyvsp[-1].no)->code);

			append_instr((yyval.no)->code, new_instr("jumpI", NULL, NULL, L_begin));
			append_instr((yyval.no)->code, new_label_instr(L_end));
		}
#line 2116 "parser.c"
    break;
...
#line 520 "parser.y"
			 ...
			 (yyval.no) = asd_new("|", TYPE_INTEIRO);
				asd_add_child((yyval.no), (yyvsp[-2].no));
				asd_add_child((yyval.no), (yyvsp[0].no));
				(yyval.no)->code = concat((yyvsp[-2].no)->code, (yyvsp[0].no)->code);
				(yyval.no)->temp = new_temp();
				append_instr((yyval.no)->code, new_instr("or", (yyvsp[-2].no)->temp, (yyvsp[0].no)->temp, (yyval.no)->temp)); }
#line 2137 "parser.c"
    break;
...
#line 534 "parser.y"
			 ...
			 (yyval.no) = asd_new("&", TYPE_INTEIRO);
				...
				(yyval.no)->code = concat((yyvsp[-2].no)->code, (yyvsp[0].no)->code);
				(yyval.no)->temp = new_temp();
				append_instr((yyval.no)->code, new_instr("and", (yyvsp[-2].no)->temp, (yyvsp[0].no)->temp, (yyval.no)->temp)); }
#line 2158 "parser.c"
    break;
...
#line 549 "parser.y"
				...
				(yyval.no) = asd_new("==", TYPE_INTEIRO);
					...
					(yyval.no)->code = concat((yyvsp[-2].no)->code, (yyvsp[0].no)->code);
					(yyval.no)->temp = new_temp();
					append_instr((yyval.no)->code, new_instr("cmp_EQ", (yyvsp[-2].no)->temp, (yyvsp[0].no)->temp, (yyval.no)->temp)); }
#line 2179 "parser.c"
    break;
...
#line 560 "parser.y"
				...
				(yyval.no) = asd_new("!=", TYPE_INTEIRO);
					...
					(yyval.no)->code = concat((yyvsp[-2].no)->code, (yyvsp[0].no)->code);
					(yyval.no)->temp = new_temp();
					append_instr((yyval.no)->code, new_instr("cmp_NE", (yyvsp[-2].no)->temp, (yyvsp[0].no)->temp, (yyval.no)->temp)); }
#line 2194 "parser.c"
    break;
...
#line 575 "parser.y"
			  ...
			  (yyval.no) = asd_new("<", TYPE_INTEIRO);
				...
				(yyval.no)->code = concat((yyvsp[-2].no)->code, (yyvsp[0].no)->code);
				(yyval.no)->temp = new_temp();
				append_instr((yyval.no)->code, new_instr("cmp_LT", (yyvsp[-2].no)->temp, (yyvsp[0].no)->temp, (yyval.no)->temp)); }
#line 2215 "parser.c"
    break;
...
#line 586 "parser.y"
			  ...
			  (yyval.no) = asd_new(">", TYPE_INTEIRO);
				...
				(yyval.no)->code = concat((yyvsp[-2].no)->code, (yyvsp[0].no)->code);
				(yyval.no)->temp = new_temp();
				append_instr((yyval.no)->code, new_instr("cmp_GT", (yyvsp[-2].no)->temp, (yyvsp[0].no)->temp, (yyval.no)->temp)); }
#line 2230 "parser.c"
    break;
...
#line 597 "parser.y"
				...
				(yyval.no) = asd_new("<=", TYPE_INTEIRO);
					...
					(yyval.no)->code = concat((yyvsp[-2].no)->code, (yyvsp[0].no)->code);
					(yyval.no)->temp = new_temp();
					append_instr((yyval.no)->code, new_instr("cmp_LE", (yyvsp[-2].no)->temp, (yyvsp[0].no)->temp, (yyval.no)->temp)); }
#line 2245 "parser.c"
    break;
...
#line 608 "parser.y"
				...
				(yyval.no) = asd_new(">=", TYPE_INTEIRO);
					...
					(yyval.no)->code = concat((yyvsp[-2].no)->code, (yyvsp[0].no)->code);
					(yyval.no)->temp = new_temp();
					append_instr((yyval.no)->code, new_instr("cmp_GE", (yyvsp[-2].no)->temp, (yyvsp[0].no)->temp, (yyval.no)->temp)); }
#line 2260 "parser.c"
    break;
...
#line 622 "parser.y"
			  ...
			  (yyval.no) = asd_new("+", (yyvsp[-2].no)->type);
				...
				(yyval.no)->code = concat((yyvsp[-2].no)->code, (yyvsp[0].no)->code);
				(yyval.no)->temp = new_temp();
				append_instr((yyval.no)->code, new_instr("add", (yyvsp[-2].no)->temp, (yyvsp[0].no)->temp, (yyval.no)->temp)); }
#line 2281 "parser.c"
    break;
...
#line 634 "parser.y"
			  ...
			  (yyval.no) = asd_new("-", (yyvsp[-2].no)->type);
				...
				(yyval.no)->code = concat((yyvsp[-2].no)->code, (yyvsp[0].no)->code);
				(yyval.no)->temp = new_temp();
				append_instr((yyval.no)->code, new_instr("sub", (yyvsp[-2].no)->temp, (yyvsp[0].no)->temp, (yyval.no)->temp)); }
#line 2296 "parser.c"
    break;
...
#line 648 "parser.y"
				...
				(yyval.no)->code = concat((yyvsp[-2].no)->code, (yyvsp[0].no)->code);
				(yyval.no)->temp = new_temp();
				append_instr((yyval.no)->code, new_instr("mult", (yyvsp[-2].no)->temp, (yyvsp[0].no)->temp, (yyval.no)->temp)); }
#line 2317 "parser.c"
    break;
...
#line 659 "parser.y"
				...
				(yyval.no)->code = concat((yyvsp[-2].no)->code, (yyvsp[0].no)->code);
				(yyval.no)->temp = new_temp();
				append_instr((yyval.no)->code, new_instr("div", (yyvsp[-2].no)->temp, (yyvsp[0].no)->temp, (yyval.no)->temp)); }
#line 2332 "parser.c"
    break;
...
#line 680 "parser.y"
                 { (yyval.no) = asd_new("+", (yyvsp[0].no)->type);
			asd_add_child((yyval.no), (yyvsp[0].no));
			(yyval.no)->code = (yyvsp[0].no)->code;
			(yyval.no)->temp = (yyvsp[0].no)->temp; }
#line 2359 "parser.c"
...
#line 685 "parser.y"
			...
			(yyval.no)->temp = new_temp();
			char *tzero = new_temp();
			append_instr((yyval.no)->code, new_instr("loadI", "0", NULL, tzero));
			append_instr((yyval.no)->code, new_instr("sub", tzero, (yyvsp[0].no)->temp, (yyval.no)->temp)); }
#line 2371 "parser.c"
    break;
...
#line 693 "parser.y"
			...
			(yyval.no)->code = (yyvsp[0].no)->code;
			(yyval.no)->temp = new_temp();
			append_instr((yyval.no)->code, new_instr("cmp_EQ", (yyvsp[0].no)->temp, "0", (yyval.no)->temp)); }
#line 2381 "parser.c"
    break;
...
#line 701 "parser.y"
			...
			(yyval.no) = asd_new((yyvsp[0].valor_lexico)->valor, sym->type);
				...
				(yyval.no)->temp = new_temp();
				if (is_global(sym))
					append_instr((yyval.no)->code, new_instr("loadAI", "rbss", sym->offset_str, (yyval.no)->temp));
        			else
					append_instr((yyval.no)->code, new_instr("loadAI", "rfp", sym->offset_str, (yyval.no)->temp));
				free((yyvsp[0].valor_lexico)->valor);
				free((yyvsp[0].valor_lexico)); }
#line 2410 "parser.c"
    break;
